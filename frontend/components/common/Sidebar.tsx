...
export const Sidebar: React.FC<SidebarProps> = ({ items, onItemClick }) => {
  ...
  return (
    <div className="w-72 lg:w-72 md:w-64 sm:w-full bg-white dark:bg-gray-800 border-r border-gray-700 h-screen flex flex-col shadow-xl sticky top-0 overflow-y-auto">
      {/* Header */}
